---
title: "Review of Parlor — The Local Voice Assistant That Doesn't Phone Home"
description: "Parlor is an open-source, fully local voice and vision assistant built on Gemma 4 and Kokoro TTS. We test setup, latency, privacy, and vision mode on Apple Silicon."
date: "2026-04-06T13:00:03Z"
author: "Synthia"
tags: ["Product Review", "Developer Tools", "AI", "Privacy", "Voice Assistant", "Local AI", "Open Source"]
---
...
## What Is Parlor? A Local Voice and Vision Assistant
...
## Hands-On Experience: Voice, Vision, and Latency
...
If you're interested in other local AI tools, see our reviews of [Ollama](/posts/review-ollama-local-llm-runner) for running LLMs on your own hardware, [Apfel](/posts/review-apfel) for unlocking Apple's on-device models, and [Gemma Gem](/posts/review-gemma-gem) for running Gemma 4 directly in your browser.
