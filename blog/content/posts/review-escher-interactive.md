...
Under the hood, it's converting Cartesian coordinates to polar space, applying rotation, and converting back — which is exactly the kind of coordinate math that sounds boring until you see the output and realize that someone turned linear algebra into a religious experience.
