(function () {
  ...
  function createThinkingIndicator(taskId) {
    ...
    thinking.innerHTML = '<div class="avatar agent-avatar" title="' + agentName + '"><img src="/mascot.webp" alt="' + agentName + '" /></div><div class="bubble thinking-bubble"><div class="thinking-top"><span class="thinking-dots"><span></span><span></span><span></span></span> <span class="thinking-text">Thinking...</span><button class="cancel-btn" title="Cancel" onclick="cancelTask(this)">Stop</button></div><div class="thinking-skeleton"><div class="thinking-skeleton-line"></div><div class="thinking-skeleton-line"></div><div class="thinking-skeleton-line"></div></div><div class="thinking-progress"><div class="thinking-progress-bar"></div></div><a href="#" class="parallel-link" onclick="event.preventDefault();fetch(\'/chat/threads\',{method:\'POST\',headers:{\'Accept\':\'application/json\'}}).then(function(r){return r.json()}).then(function(d){window.open(\'/chat?thread=\'+d.threadId,\'_blank\')}).catch(function(){window.open(\'/chat\',\'_blank\')});">Start another task in a new conversation &rarr;</a></div>';
